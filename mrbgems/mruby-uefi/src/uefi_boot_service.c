...
mrb_init_uefi_boot_service(mrb_state *mrb, struct RClass *mrb_uefi)
{
    ...
    mrb_define_module_function(mrb, bs, "pointer", bs_pointer, MRB_ARGS_NONE());

    mrb_define_module_function(mrb, bs, "handle_protocol", bs_handle_protocol, MRB_ARGS_REQ(2));
    mrb_define_module_function(mrb, bs, "protocols_per_handle", bs_protocols_per_handle, MRB_ARGS_REQ(1));
    mrb_define_module_function(mrb, bs, "locate_handle_buffer", bs_locate_handle_buffer, MRB_ARGS_REQ(1));
    mrb_define_module_function(mrb, bs, "locate_protocol", bs_locate_protocol, MRB_ARGS_REQ(1));
}
