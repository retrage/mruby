...
mrb_init_uefi_handle(mrb_state *mrb, struct RClass *mrb_uefi)
{
    ...
    mrb_define_method(mrb, h_cls, "==", mrb_uefi_handle_eq, MRB_ARGS_REQ(1));
    mrb_define_method(mrb, h_cls, "to_s", mrb_uefi_handle_to_s, MRB_ARGS_NONE());
    mrb_define_method(mrb, h_cls, "inspect", mrb_uefi_handle_inspect, MRB_ARGS_NONE());
    mrb_define_method(mrb, h_cls, "value", mrb_uefi_handle_value, MRB_ARGS_NONE());

    mrb_const_set(mrb, mrb_obj_value(h_cls), mrb_intern(mrb, "NULL", sizeof("NULL") - 1),
