...
mrb_init_uefi_pointer(mrb_state *mrb, struct RClass *mrb_uefi)
{
    ...
    mrb_define_method(mrb, p_cls, "initialize", mrb_uefi_pointer_initialize, MRB_ARGS_ANY());
    mrb_define_method(mrb, p_cls, "initialize_copy", mrb_uefi_pointer_initialize_copy, MRB_ARGS_REQ(1));
    mrb_define_method(mrb, p_cls, "<=>", mrb_uefi_pointer_cmp, MRB_ARGS_REQ(1));
    mrb_define_method(mrb, p_cls, "to_s", mrb_uefi_pointer_to_s, MRB_ARGS_NONE());
    mrb_define_method(mrb, p_cls, "inspect", mrb_uefi_pointer_inspect, MRB_ARGS_NONE());
    mrb_define_method(mrb, p_cls, "value", mrb_uefi_pointer_value, MRB_ARGS_NONE());
    mrb_define_method(mrb, p_cls, "to_i", mrb_uefi_pointer_to_i, MRB_ARGS_NONE());
    mrb_define_method(mrb, p_cls, "+", mrb_uefi_pointer_plus, MRB_ARGS_REQ(1));
    mrb_define_method(mrb, p_cls, "-", mrb_uefi_pointer_minus, MRB_ARGS_REQ(1));
    mrb_define_method(mrb, p_cls, "read", mrb_uefi_pointer_read, MRB_ARGS_REQ(1));
    mrb_define_method(mrb, p_cls, "write", mrb_uefi_pointer_write, MRB_ARGS_REQ(1));

    mrb_const_set(mrb, mrb_obj_value(p_cls), mrb_intern(mrb, "NULL", sizeof("NULL") - 1),
